...
class BienRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            "biens.swim_exist.*.volume"=> 'required|integer',
            "biens.swim_exist.*.dimensions"=> 'required|integer',
            "biens.swim_exist.*.treatment"=> 'required|string',
            "biens.number_garage"=> 'required|integer',
            "biens.indoor_parking"=> 'required|integer',
            "biens.outdoor_parking"=> 'required|integer',
