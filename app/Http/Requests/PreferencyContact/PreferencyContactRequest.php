...
class PreferencyContactRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            "preferencyContact.garden_exist_area"=> 'nullable|float',
            "preferencyContact.land_area"=> 'nullable|float',
            "preferencyContact.swim"=> 'nullable|integer',
            "preferencyContact.swim_exist_area"=> 'nullable|float',
            ...
            "preferencyContact.carrez_area"=> 'nullable|float',
            "preferencyContact.stay_area"=> 'nullable|float',
