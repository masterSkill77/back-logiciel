...
class PreferenceContacts extends Model
{
    ...
    protected $fillable = [
        'criteria', 'min_budgets', 'max_budgets', 'min_surface', 'max_surface', 'min_room', 'max_room', 'min_bedroom', 'max_bedroom', 'localities', 'start_date', 'end_date', 'night_number', 'type_offert_id', 'type_estate_id',
        ...
        'fireplace', 'glazing', 'ground_surface', 'poolable', 'wooded', 'divisible'
    ];
}
