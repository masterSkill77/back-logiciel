...
class Diagnostic extends Model
{
    ...
    protected $fillable = ['year_construction', 'dpe_date_realization', 'dpe_property', 'dpe_virgin', 'dpe_consommation', 'dpe_ges', 'cost_estimate', 'ref_year'
    , 'amiante', 'amiante_yes_date', 'amiante_yes_comments', 'electric', 'electric_yes_date', 'electric_yes_date', 'electric_yes_comments', 'gaz', 'gaz_yes_date', 'gaz_yes_comments'
